...
| Paper | Authors | Backbone Model | Task Category | Dataset Type| Venue | Approach | Summary |
|------------------------|--------------|----------------|---------------|------------------|---------|---------|---------|
| [WinCLIP: Zero-/few-shot anomaly classification and segmentation](https://cvpr.org/2023) | Jongheon Jeong, Yang Zou, Taewan Kim, Dongqing Zhang, Avinash Ravichandran, Onkar Dabeer | CLIP | Anomaly Classification | - | CVPR, 2023 | - | - |
| [AnomalyGPT: Detecting industrial anomalies using large vision-language models](https://arxiv.org/abs/2023) | Zhaopeng Gu, Bingke Zhu, Guibo Zhu, Yingying Chen, Ming Tang, Jinqiao Wang | GPT | Anomaly Detection | Industrial Data | arXiv, 2023 | - | - |
| [AnoVL: Adapting vision-language models for unified zero-shot anomaly localization](https://arxiv.org/abs/2023) | Hanqiu Deng, Zhaoxiang Zhang, Jinan Bao, Xingyu Li | - | Anomaly Localization | - | arXiv, 2023 | - | - |
| [CLIPN for zero-shot OOD detection: Teaching CLIP to say no](https://iccv.org/2023) | Hualiang Wang, Yi Li, Huifeng Yao, Xiaomeng Li | CLIP | OOD Detection | - | ICCV, 2023 | - | - |
| [Semantic scene difference detection in daily life patrolling by mobile robots using pre-trained large-scale vision-language model](https://iros.org/2023) | Yoshiki Obinata, Kento Kawaharazuka, Naoaki Kanazawa, Naoya Yamaguchi, Naoto Tsukamoto, Iori Yanokura, Shingo Kitagawa, Koki Shinjo, Kei Okada, Masayuki Inaba | - | Scene Difference Detection | - | IROS, 2023 | - | - |
| [AnomalyCLIP: Object-agnostic prompt learning for zero-shot anomaly detection](https://iclr.org/2024) | Qihang Zhou, Guansong Pang, Yu Tian, Shibo He, Jiming Chen | CLIP | Anomaly Detection | - | ICLR, 2024 | - | - |
| [CLIP-AD: A language-guided staged dual-path model for zero-shot anomaly detection](https://arxiv.org/abs/2023) | Xuhai Chen, Jiangning Zhang, Guanzhong Tian, Haoyang He, Wuhao Zhang, Yabiao Wang, Chengjie Wang, Yunsheng Wu, Yong Liu | CLIP | Anomaly Detection | - | arXiv, 2023 | - | - |
| [Exploring grounding potential of VQA-oriented GPT-4V for zero-shot anomaly detection](https://arxiv.org/abs/2023) | Jiangning Zhang, Xuhai Chen, Zhucun Xue, Yabiao Wang, Chengjie Wang, Yong Liu | GPT-4V | Anomaly Detection | - | arXiv, 2023 | - | - |
| [Open-vocabulary video anomaly detection](https://arxiv.org/abs/2023) | Peng Wu, Xuerong Zhou, Guansong Pang, Yujia Sun, Jing Liu, Peng Wang, Yanning Zhang | - | Anomaly Detection | Video | arXiv, 2023 | - | - |
| [Distilling out-of-distribution robustness from vision-language foundation models](https://nips.org/2023) | Andy Zhou, Jindong Wang, Yuxiong Wang, Haohan Wang | - | OOD Detection | - | NIPS, 2023 | - | - |
| [How well does GPT-4V(ision) adapt to distribution shifts? A preliminary investigation](https://arxiv.org/abs/2023) | Zhongyi Han, Guanglin Zhou, Rundong He, Jindong Wang, Xing Xie, Tailin Wu, Yilong Yin, Salman Khan, Lina Yao, Tongliang Liu, Kun Zhang | GPT-4V | Distribution Shift | - | arXiv, 2023 | - | - |
| [Toward generalist anomaly detection via in-context residual learning with few-shot sample prompts](https://cvpr.org/2024) | Jiawen Zhu, Guansong Pang | - | Anomaly Detection | - | CVPR, 2024 | - | - |
| [Adapting visual-language models for generalizable anomaly detection in medical images](https://cvpr.org/2024) | Chaoqin Huang, Aofan Jiang, Jinghao Feng, Ya Zhang, Xinchao Wang, Yanfeng Wang | - | Anomaly Detection | Medical Images | CVPR, 2024 | - | - |
| [PromptAD: Learning prompts with only normal samples for few-shot anomaly detection](https://cvpr.org/2024) | Xiaofan Li, Zhizhong Zhang, Xin Tan, Chengwei Chen, Yanyun Qu, Yuan Xie, Lizhuang Ma | - | Anomaly Detection | - | CVPR, 2024 | - | - |
| [Text prompt with normality guidance for weakly supervised video anomaly detection](https://arxiv.org/abs/2024) | Zhiwei Yang, Jing Liu, Peng Wu | - | Anomaly Detection | Video | arXiv, 2024 | - | - |
| [AnomalyDINO: Boosting patch-based few-shot anomaly detection with DINOv2](https://arxiv.org/abs/2024) | Simon Damm, Mike Laszkiewicz, Johannes Lederer, Asja Fischer | DINOv2 | Anomaly Detection | - | arXiv, 2024 | - | - |
| [Exploring the Limits of Out-of-Distribution Detection](https://neurips.org/2021) | Stanislav Fort, Jie Ren, Balaji Lakshminarayanan | - | OOD Detection | - | NeurIPS, 2021 | - | - |
| [Delving into Out-of-Distribution Detection with Vision-Language Representations](https://neurips.org/2022) | Ming et al. | - | OOD Detection | - | NeurIPS, 2022 | - | - |
| [Zero-shot out-of-distribution detection based on the pretrained model CLIP](https://aaai.org/2022) | Sepideh Esmaeilpour, Bing Liu, Eric Robertson, Lei Shu | CLIP | OOD Detection | - | AAAI, 2022 | - | - |
| [LoCoOp: Few-Shot Out-of-Distribution Detection via Prompt Learning](https://neurips.org/2023) | Miyai et al. | - | OOD Detection | - | NeurIPS, 2023 | Prompt Learning | - |
| [CLIPN for Zero-Shot OOD Detection: Teaching CLIP to Say No](https://iccv.org/2023) | Wang et al. | CLIP | OOD Detection | - | ICCV, 2023 | Negative Prompts | - |
| [How Does Fine-Tuning Impact Out-of-Distribution Detection for Vision-Language Models?](https://ijcv.org/2023) | Yifei Ming, Yixuan Li | - | OOD Detection | - | IJCV, 2023 | Fine-Tuning | - |
| [Out-Of-Distribution Detection With Negative Prompts](https://iclr.org/2024) | Nie et al. | - | OOD Detection | - | ICLR, 2024 | Negative Prompts | - |
| [Negative Label Guided OOD Detection with Pretrained Vision-Language Models](https://iclr.org/2024) | Xue Jiang, Feng Liu, Zhen Fang, Hong Chen, Tongliang Liu, Feng Zheng, Bo Han | - | OOD Detection | - | ICLR, 2024 | Negative Label Guidance | - |
| [ID-like Prompt Learning for Few-Shot Out-of-Distribution Detection](https://cvpr.org/2024) | Yichen Bai, Zongbo Han, Changqing Zhang, Bing Cao, Xiaoheng Jiang, Qinghua Hu | - | OOD Detection | - | CVPR, 2024 | ID-like Prompt Learning | - |
| [Learning transferable negative prompts for out-of-distribution detection](https://cvpr.org/2024) | Tianqi Li, Guansong Pang, Xiao Bai, Wenjun Miao, Jin Zheng | - | OOD Detection | - | CVPR, 2024 | Transferable Negative Prompts | - |
| [Adapting Contrastive Language-Image Pretrained (CLIP) Models for Out-of-Distribution Detection](https://tmlr.org/2024) | Nikolas Adaloglou, Felix Michels, Tim Kaiser, Markus Kollmann | CLIP | OOD Detection | - | TMLR, 2024 | Contrastive Learning | - |
| [Tagfog: Textual anchor guidance and fake outlier generation for visual out-of-distribution detection](https://aaai.org/2024) | Jiankang Chen, Tong Zhang, Weishi Zheng, Ruixuan Wang | - | OOD Detection | - | AAAI, 2024 | Textual Anchor Guidance | - |
| [Domain aligned CLIP for few-shot classification](https://wacv.org/2024) | Muhammad Waleed Gondal, Jochen Gast, Inigo Alonso Ruiz, Richard Droste, Tommaso Macri, Suren Kumar, Luitpold Staudigl | CLIP | Few-shot Classification | - | WACV, 2024 | Domain Alignment | - |
