...
| [Envisioning outlier exposure by large language models for out-of-distribution detection](https://arxiv.org/abs/2406.00806) | Chentao Cao, Zhun Zhong, Zhanke Zhou, Yang Liu, Tongliang Liu, Bo Han | GPT-3.5-turbo-16k | OOD Detection | Vision | ICML, 2024 | Prompting |
| [Out-of-Distribution Detection Using Peer-Class Generated by Large Language Model](https://arxiv.org/abs/2403.13324) | K Huang, G Song, Hanwen Su, Jiyan Wang | GPT-3; CLIP | OOD Detection | Vision | ArXiv, 2024 | Prompting |
| [Contrastive Novelty-Augmented Learning: Anticipating Outliers with Large Language Models](https://aclanthology.org/2023.acl-long.658.pdf) | Albert Xu, Xiang Ren, Robin Jia | GPT-3; CLIP | OOD Detection | Vision | ACL, 2023 | Prompting |
| [AnomalyGPT: Detecting Industrial Anomalies Using Large Vision-Language Models](https://arxiv.org/pdf/2308.15366) | Zhaopeng Gu, Bingke Zhu, Guibo Zhu, Yingying Chen, Ming Tang, Jinqiao Wang | ImageBind-Huge; Vicuna-7B | Anomaly Detection | Vision | ArXiv, 2024 | Prompting; Prompt-Tuning |
